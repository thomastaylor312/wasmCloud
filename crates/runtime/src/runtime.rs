...
impl RuntimeBuilder {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            // Why so large you ask? Well, python components are chonky, like 35MB for a hello world chonky. So this is pretty big for now.
    ...
    pub fn build(mut self) -> anyhow::Result<Runtime> {
        ...
        pooling_config
            ...
            .linear_memory_keep_resident(10 << 20)
            .table_keep_resident(10 << 20);
        self.engine_config
